...
fusuariosedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($usuarios_edit->idusuarios->Required) { ?>
			elm = this.getElements("x" + infix + "_idusuarios");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $usuarios->idusuarios->caption(), $usuarios->idusuarios->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($usuarios_edit->nombrecompleto->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuarios_edit->contrasenia->Required) { ?>
		...
		<?php } ?>
		<?php if ($usuarios_edit->userlevel_id->Required) { ?>
...
fusuariosedit.lists["x_userlevel_id"] = <?php echo $usuarios_edit->userlevel_id->Lookup->toClientList() ?>;
fusuariosedit.lists["x_userlevel_id"].options = <?php echo JsonEncode($usuarios_edit->userlevel_id->lookupOptions()) ?>;
...
<?php if ($usuarios->idusuarios->Visible) { // idusuarios ?>
	<div id="r_idusuarios" class="form-group row">
		<label id="elh_usuarios_idusuarios" class="<?php echo $usuarios_edit->LeftColumnClass ?>"><?php echo $usuarios->idusuarios->caption() ?><?php echo ($usuarios->idusuarios->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuarios_edit->RightColumnClass ?>"><div<?php echo $usuarios->idusuarios->cellAttributes() ?>>
<span id="el_usuarios_idusuarios">
<span<?php echo $usuarios->idusuarios->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($usuarios->idusuarios->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="usuarios" data-field="x_idusuarios" name="x_idusuarios" id="x_idusuarios" value="<?php echo HtmlEncode($usuarios->idusuarios->CurrentValue) ?>">
<?php echo $usuarios->idusuarios->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($usuarios->nombrecompleto->Visible) { // nombrecompleto ?>
	<div id="r_nombrecompleto" class="form-group row">
		<label id="elh_usuarios_nombrecompleto" for="x_nombrecompleto" class="<?php echo $usuarios_edit->LeftColumnClass ?>"><?php echo $usuarios->nombrecompleto->caption() ?><?php echo ($usuarios->nombrecompleto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuarios_edit->RightColumnClass ?>"><div<?php echo $usuarios->nombrecompleto->cellAttributes() ?>>
...
<?php if ($usuarios->correo->Visible) { // correo ?>
	<div id="r_correo" class="form-group row">
		<label id="elh_usuarios_correo" for="x_correo" class="<?php echo $usuarios_edit->LeftColumnClass ?>"><?php echo $usuarios->correo->caption() ?><?php echo ($usuarios->correo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuarios_edit->RightColumnClass ?>"><div<?php echo $usuarios->correo->cellAttributes() ?>>
...
<?php if ($usuarios->contrasenia->Visible) { // contrasenia ?>
	<div id="r_contrasenia" class="form-group row">
		<label id="elh_usuarios_contrasenia" for="x_contrasenia" class="<?php echo $usuarios_edit->LeftColumnClass ?>"><?php echo $usuarios->contrasenia->caption() ?><?php echo ($usuarios->contrasenia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuarios_edit->RightColumnClass ?>"><div<?php echo $usuarios->contrasenia->cellAttributes() ?>>
...
<?php if ($usuarios->userlevel_id->Visible) { // userlevel_id ?>
	<div id="r_userlevel_id" class="form-group row">
		<label id="elh_usuarios_userlevel_id" for="x_userlevel_id" class="<?php echo $usuarios_edit->LeftColumnClass ?>"><?php echo $usuarios->userlevel_id->caption() ?><?php echo ($usuarios->userlevel_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $usuarios_edit->RightColumnClass ?>"><div<?php echo $usuarios->userlevel_id->cellAttributes() ?>>
