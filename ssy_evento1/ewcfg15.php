...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.6");
...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "project5"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'tWKDi377Ahm3o34S'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/project5.css"); // Project stylesheet file name
...
define(PROJECT_NAMESPACE . "FONT_SIZE", 16);
define(PROJECT_NAMESPACE . "TEMP_IMAGE_FONT", "DejaVuSans"); // Font for temp files
$PROJECT_ID = "{7D17B05A-1E09-4241-BCB8-DFDB2802E5B9}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "29072011", "db" => "ssy", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "masteradmin"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "29072011"); // Administrator password
...
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "nombrecompleto");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "contrasenia");
define(PROJECT_NAMESPACE . "USER_ID_FIELD_NAME", "");
define(PROJECT_NAMESPACE . "USER_LEVEL_FIELD_NAME", "userlevel_id");
define(PROJECT_NAMESPACE . "USER_PROFILE_FIELD_NAME", "");
define(PROJECT_NAMESPACE . "REGISTER_ACTIVATE_FIELD_NAME", "");
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "correo");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "`usuarios`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`nombrecompleto` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(`correo` = '%e')");
...
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "aura.rmp00@gmail.com"); // Sender email address
define(PROJECT_NAMESPACE . "RECIPIENT_EMAIL", "aura.rmp00@gmail.com"); // Recipient email address
