...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Wikipedia-Flags-MX-YUC-Yucatan-Flag.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>Wikipedia-Flags-MX-YUC-Yucatan-Flag.ico">
<meta name="generator" content="PHPMaker v2019.0.6">
</head>
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>phpimages/logo-rinon-lazo.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
