...
class usuarios_view extends usuarios
{
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("idusuarios") !== NULL) {
			$this->RecKey["idusuarios"] = Get("idusuarios");
			$keyUrl .= "&amp;idusuarios=" . urlencode($this->RecKey["idusuarios"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idusuarios") !== NULL) {
				$this->idusuarios->setQueryStringValue(Get("idusuarios"));
				$this->RecKey["idusuarios"] = $this->idusuarios->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->idusuarios->setQueryStringValue(Key(0));
				$this->RecKey["idusuarios"] = $this->idusuarios->QueryStringValue;
			} elseif (Post("idusuarios") !== NULL) {
				$this->idusuarios->setFormValue(Post("idusuarios"));
				$this->RecKey["idusuarios"] = $this->idusuarios->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->idusuarios->setFormValue(Route(2));
				$this->RecKey["idusuarios"] = $this->idusuarios->FormValue;
			} else {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fusuariosview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fusuariosview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fusuariosview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
