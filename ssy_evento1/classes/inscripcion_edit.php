 ...
 * Page class
 */
class inscripcion_edit extends inscripcion
{
	...
	// Page object name
	public $PageObjName = "inscripcion_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_idinscripcion")) {
				$this->idinscripcion->setFormValue($CurrentForm->getValue("x_idinscripcion"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->idinscripcion->IsDetailKey)
			$this->idinscripcion->setFormValue($val);
