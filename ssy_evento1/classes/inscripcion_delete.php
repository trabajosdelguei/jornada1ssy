 ...
 * Page class
 */
class inscripcion_delete extends inscripcion
{
	...
	// Page object name
	public $PageObjName = "inscripcion_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("inscripcionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("inscripcionlist.php"); // Return to list
			}
		}
	}
